...
class DefaultBox(Layer):
    def __init__(self, img_size, min_size, max_size, aspect_ratios, variance, **kwargs):
    ...
    def call(self, x, mask=None):
        ...
        variance = np.ones((num_boxes, 4)) * self.variance
        default_boxes = np.concatenate((default_boxes, variance), axis=1)
